    ...
    <div class=" navbar-collapse d-lg-flex" id="navLinks">
      <ul class="navbar-nav col-lg-6 justify-content-lg-center gap-3">
        ...
        <?php if (isset($_SESSION['user_id'])): ?>
          <li><a href="/meutickets" class="nav-link">Suporte</a></li>
        <?php endif; ?>
      </ul>
    ...
    Cadastrar-se
      ...
      <?php else: ?>
        <div class="dropdown text-end col-lg-3 d-flex justify-content-end align-items-center">
          <a href="#" class="d-flex align-items-center text-decoration-none dropdown-toggle position-relative" data-bs-toggle="dropdown">
          <div class="position-relative me-2">
              <img src="<?php echo htmlspecialchars($_SESSION['user_avatar'] ?? __DIR__ . 'images/upload/pfp/avatar.png')?>"
                     alt="Foto" width="32" style="min-width: 32px; max-width: 32px; min-height: 32px; max-height: 32px;" height="32" class="rounded-circle">
              <?php if (isset($_SESSION['cadastro_incompleto']) && $_SESSION['cadastro_incompleto']): ?>
                <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" title="Cadastro incompleto">
                  <span class="visually-hidden">Cadastro incompleto</span>
                </span>
              <?php endif; ?>
            </div>
