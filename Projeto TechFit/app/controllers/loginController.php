...
function processCadastro(): void
{
    ...
    // Determinar tipo por email
    $tipo = str_ends_with(strtolower($email), '@techfit.com') ? 'funcionario' : 'usuario';
