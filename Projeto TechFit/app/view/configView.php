<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md mb-6">
        ...
        <form method="post" action="/profile?page=configuracao" enctype="multipart/form-data">
            <input type="hidden" name="acao" value="alterar_avatar">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <div class="w-full flex justify-center">
                        <img id="previewAvatar"
                             src="<?= htmlspecialchars($data['user_avatar'] ?? '/images/upload/pfp/avatar.png') ?>"
        ...
        function handleFileChange(input) {
            ...
            if (file) {
                ...
                if (!allowedTypes.includes(file.type)) {
                    ...
                    fileInput.value = '';
                    fileInput2.value = '';
                    previewImg.src = "<?= htmlspecialchars($data['user_avatar'] ?? '/images/upload/pfp/avatar.png') ?>";
                    return;
                }
        ...
        <form method="post" action="/profile?page=configuracao">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input type="text" name="nome" value="<?php echo htmlspecialchars($data['nome']) ?>"
            ...
            <?php if (strtolower($data['tipo']) === 'usuario'): ?>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        <label class="block mb-2 text-gray-600 font-medium">Telefone:</label>
                        <input type="tel" name="telefone" value="<?php echo htmlspecialchars($data['telefone'] ?? '') ?>"
                    ...
                    <div>
                        ...
                        <select name="genero" class="border border-gray-300 p-3 w-full rounded focus:outline-none focus:border-blue-500">
                            ...
                            <option value="Feminino" <?php echo($data['genero'] ?? '') === 'Feminino' ? 'selected' : '' ?>>Feminino</option>
                            <option value="Outro" <?php echo($data['genero'] ?? '') === 'Outro' ? 'selected' : '' ?>>Outro</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="endereco"
                              ...
                              rows="3"><?php echo htmlspecialchars($data['endereco'] ?? '') ?></textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 bg-gray-50 p-4 rounded">
                    <div>
                        ...
                        <input type="text" value="<?php echo htmlspecialchars($data['cpf'] ?? '') ?>"
                    ...
                    <div>
                        ...
                        <input type="date" value="<?php echo htmlspecialchars($data['data_nascimento'] ?? '') ?>"
                               class="border border-gray-300 p-3 w-full rounded bg-gray-100"
                               disabled>
    ...
    <script>
        ...
        const changePassAction = document.querySelector('input[name="acao"][value="alterar_senha"]');
        if (changePassAction) {
